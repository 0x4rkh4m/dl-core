...
jobManager.addJob("unemployed", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Freelancer, payment: 0 } },
});
...
jobManager.addJob("bus", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Driver, payment: 50 } },
});
...
jobManager.addJob("judge", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Judge, payment: 100 } },
});
...
jobManager.addJob("lawyer", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Lawyer, payment: 50 } },
});
...
jobManager.addJob("reporter", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Journalist, payment: 50 } },
});
...
jobManager.addJob("tow", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Picker, payment: 50 } },
});
...
jobManager.addJob("garbage", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Collector, payment: 50 } },
});
...
jobManager.addJob("hotdog", {
  ...
  defaultDuty: true,
  offDutyPay: false,
  grades: { "0": { name: GradeLevel.Sales, payment: 50 } },
});
